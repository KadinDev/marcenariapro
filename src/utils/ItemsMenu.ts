export const links = [
    ...
    { id: '5', path: '/entregas', text: 'Entregas', icon: 'FaTruck' },
    { id: '6', path: '/notes', text: 'Lembretes', icon: 'GiNotebook' },
]

export const linksSection = [
    { id: '1', path: '/perfilmarcenaria', text: 'Perfil', icon: 'RiUserSettingsLine'},
]